...
def get_food_image_url(item_name):
    ...
    if not found:
        ...
        # Assuming the image name in Supabase is the item_name with spaces replaced by underscores and lowercase
        supabase_image_name = item_name.lower().replace(" ", "_") + ".jpg" # Assuming .jpg as default extension
        return f"{SUPABASE_URL}/storage/v1/object/public/menu-images/{supabase_image_name}"
